<li class="item col_4">
<span class="foto-producto"><img class="productosimg" src="<?php echo Yii::app()->request->baseUrl; ?>/lineasImages/<?php echo $data->sublinea->linea->clave.'.jpg'; ?>" alt="producto" width="300" height="180" /></span>
