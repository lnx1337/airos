...
<span class="campo">
<label>Nombre</label>
<input class="col_5" id="nombre" type="text" placeholder="Nombre">
</span>
<span class="campo">
<label>E-mail</label>
<input class="col_5" id="email" type="text" placeholder="mail@domain.com">
</span>
<span class="campo">
<label>Teléfono</label>
<input class="col_5" id="telefono" type="text" placeholder="55 555 555">
</span>
<span class="campo">
...
<select id="select3" multiple="multiple" class="fancy">
  ...
  <label>Otros:</label>
<input class="col_5" id="otro" type="text">
</span>
<span class="campo">
<label class="sel">Comentarios</label>
