 ...
 *
 * The followings are the available columns in table 'tbl_imagenes':
 * @property integer $id
 * @property string $url
 *
...
class Imagenes extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'tblProductoses' => array(self::MANY_MANY, 'TblProductos', 'tbl_imagenes_has_tbl_productos(imagen_id, producto_id)'),
		);
	}
